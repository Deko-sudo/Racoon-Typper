...
| TD-NEW11 | Long-history reporting semantics (Task D): V009 deterministic ordering indexes; explicit tie-break ordering for history and personal-best lists; 10k planner and timing regression evidence; dashboard/achievement global best and streak reads use maintained projections; intentionally recent consistency window documented in ADR 0002. | Phase 4 G4 |

...
| TM-2 | IPC error strings can disclose dynamic details. Backup diagnostics are now opt-in, bounded, structured, and redacted; the remaining issue is the public error boundary. | Open — Task J |
